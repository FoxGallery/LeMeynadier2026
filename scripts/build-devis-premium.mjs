...
/**
 * Génère le PDF du devis Premium (admin + commande à emporter)
 * à partir de docs/devis/devis-lemeynadier-premium.html.
 *
 * Usage : node scripts/build-devis-premium.mjs
 */
...
const HTML_PATH = resolve(ROOT, 'docs/devis/devis-lemeynadier-premium.html')
const PDF_PATH = resolve(ROOT, 'docs/devis/Devis-Le-Meynadier-Premium.pdf')
...
console.log(`✓ Devis Premium généré : ${PDF_PATH}`)
